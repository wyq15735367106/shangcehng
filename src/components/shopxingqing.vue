  ...
  <div class="shopxigqing">
    ...
    <div class="center">
      ...
      <div class="price cl">
        ...
        <!-- 底部 -->
        <div class="footer">
          <p @click="fukuan" v-if="is_buy==1&&is_upgrade==2">立即购买</p>
          <p @click="fukuan" v-else-if="is_buy==1&&is_upgrade==1">立即升级</p>
          <p v-else-if="is_buy==2" style="background:#ABABAB"> 不可购买</p>
        </div>
    </div>
</template>
